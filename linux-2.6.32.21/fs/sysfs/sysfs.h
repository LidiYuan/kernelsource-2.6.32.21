...
struct sysfs_dirent {
	...
	union {
		struct sysfs_elem_dir		s_dir;  //表示对象 目录
		struct sysfs_elem_symlink	s_symlink; //表示对象连接 指向另一个对象
		struct sysfs_elem_attr		s_attr; //对象属性  文件
...
#define SYSFS_DIR			0x0001  //目录  即对象
#define SYSFS_KOBJ_ATTR			0x0002 //文件 对象属性
#define SYSFS_KOBJ_BIN_ATTR		0x0004 //文件 对象二进制属性
#define SYSFS_KOBJ_LINK			0x0008 //对象连接 指向另一个对象
