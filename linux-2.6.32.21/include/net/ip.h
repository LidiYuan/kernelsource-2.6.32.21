...
#define IP_DF		0x4000		/* Flag: "Don't Fragment" 0100	*/
...
/* From inetpeer.c */
extern int inet_peer_threshold; //内存限制
...
//指出了重组函数的调用位置 ip_defrag
enum ip_defrag_users
{
	IP_DEFRAG_LOCAL_DELIVER, //表明是在ip_local_deliver中调用的
	IP_DEFRAG_CALL_RA_CHAIN, //表明是在ip_call_ra_chain中调用的
