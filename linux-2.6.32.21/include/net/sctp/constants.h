...
typedef enum {
	...
	SCTP_STATE_EMPTY		= 0,
	SCTP_STATE_CLOSED		= 1,    //关联已经关闭
	SCTP_STATE_COOKIE_WAIT		= 2, //关联已经发送INIT
	SCTP_STATE_COOKIE_ECHOED	= 3, //关联已经回射COOKIE
	SCTP_STATE_ESTABLISHED		= 4, //关联已经建立
	SCTP_STATE_SHUTDOWN_PENDING	= 5, //关联发送SHUTDOWN 缓冲区还有数据未发送完延迟发送SHUTDOWN
	SCTP_STATE_SHUTDOWN_SENT	= 6, //发送了SHUTDOWN
	SCTP_STATE_SHUTDOWN_RECEIVED	= 7,//关联收到了SHUTDOWN
	SCTP_STATE_SHUTDOWN_ACK_SENT	= 8, //关联在等待SHUTDOWN_COMPLETE
