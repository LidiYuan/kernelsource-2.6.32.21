...
struct nf_conn {
	...
	/* These are my tuples(五元组); original and reply */
	struct nf_conntrack_tuple_hash tuplehash[IP_CT_DIR_MAX];//跟踪连接双方向数据初始化方向和回复方向
	...
	//定时器函数  超时后引用计数减1 //定时器设置为death_by_timeout
