...
#define NDISC_ROUTER_SOLICITATION	    133 //路由器请求
#define NDISC_ROUTER_ADVERTISEMENT	    134 //路由器通告
#define NDISC_NEIGHBOUR_SOLICITATION	135//邻居请求
#define NDISC_NEIGHBOUR_ADVERTISEMENT	136//邻居通告
#define NDISC_REDIRECT			        137 //邻居重定向
