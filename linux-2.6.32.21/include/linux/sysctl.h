...
// sysctl
/*
register_sysctl_table()    //  在/proc/sys下加入文件
unregister_sysctl_table()  // 在/proc/sys下移除文件
*/
struct ctl_table 
{
	...
	struct ctl_table *parent;	/* Automatically set sysctl_set_parent()*/
	proc_handler *proc_handler;	/* 当对文件读取或写入的时候 调用此函数  根据值的类型 初始化为不同的函数如字符串 proc_dostring()*/
