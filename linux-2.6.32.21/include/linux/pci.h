 ...
 */
struct pci_dev {
	struct list_head bus_list;	/* node in per-bus list 挂入所在总线的链表 */
	
	struct pci_bus	*bus;		/* bus this device is on 指向所在的总线*/
	struct pci_bus	*subordinate;	/* bus this device bridges to 若此设备为pci桥 还要将此指针指向代表着另一条PCI总线的pci_bus */
...
struct pci_bus {
	...
	struct list_head children;	/* list of child buses 
	                 ...
	                 */
	struct list_head devices;	/* list of devices on this bus 在这个pci总线的设备列表*/
