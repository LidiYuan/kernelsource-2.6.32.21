...
static struct genl_family nl80211_fam = {
	.id = GENL_ID_GENERATE,	/* don't bother with a hardcoded ID 为0 自动分配一个id*/
	.name = "nl80211",	/* have users key off the name instead 必须是独一无二的*/
	.hdrsize = 0,		/* no private header 私有头的大小 */
	.version = 1,		/* no particular meaning now */
	.maxattr = NL80211_ATTR_MAX, //支持的最大属性数
	.netnsok = true,//是否能处理网络命名空间
};
