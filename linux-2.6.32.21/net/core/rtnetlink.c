 ...
 */
void rtnl_register(int protocol,//指定协议族 若不针对任何协议可以写成 PF_UNSPEC
                           int msgtype,//消息类型  RTM_NEWLINK
		                   rtnl_doit_func doit, //用于指定添加 删除修改等操作
		                   rtnl_dumpit_func dumpit)//用于检索
{
