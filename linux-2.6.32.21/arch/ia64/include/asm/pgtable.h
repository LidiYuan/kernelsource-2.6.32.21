...
/*
xxx_clear();将相应的页表项清空
xxx_none()在相应的项不存在返回1
xxx_present() 检查页表项 的PRESENT位被置1返回1
xx_page() 返回一个page{}地址
 ...
 * access rights:
 */
#define pte_wrprotect(pte)	(__pte(pte_val(pte) & ~_PAGE_AR_RW))//清除写权限
#define pte_mkwrite(pte)	(__pte(pte_val(pte) | _PAGE_AR_RW))//设置写权限
